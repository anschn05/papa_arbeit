...
mat = z_MW.reshape(step,step)

# in matrix gespeichert, aber vertikal gespiegelt!
top_left     = mat[:int(step/2), :int(step/2)]
top_right    = mat[:int(step/2), int(step/2):]
bottom_left  = mat[int(step/2):, :int(step/2)]
bottom_right = mat[int(step/2):, int(step/2):]
